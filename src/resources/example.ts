...
exampleResource
  ...
  .addHelpText("after", "\nExamples:\n  thumbfast-cli examples list\n  thumbfast-cli examples list --limit 5 --json")
...
exampleResource
  ...
  .option("--json", "Output as JSON")
  .option("--format <fmt>", "Output format: text, json, csv, yaml")
  .addHelpText("after", "\nExample:\n  thumbfast-cli examples get abc123")
...
exampleResource
  ...
  .option("--json", "Output as JSON")
  .addHelpText("after", '\nExample:\n  thumbfast-cli examples create --name "My Example"')
  .action(async (opts: ActionOpts) => {
    try {
...
exampleResource
  ...
  .option("--json", "Output as JSON")
  .addHelpText("after", '\nExample:\n  thumbfast-cli examples update abc123 --name "Updated"')
  .action(async (id: string, opts: ActionOpts) => {
    try {
...
exampleResource
  ...
  .argument("<id>", "Example ID")
  .option("--json", "Output as JSON")
  .addHelpText("after", "\nExample:\n  thumbfast-cli examples delete abc123")
  .action(async (id: string, opts: ActionOpts) => {
    try {
